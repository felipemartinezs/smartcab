...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):#, decay_rate = 0.05):
        ...
        #self.epsilon_decay_rate = decay_rate # class decay factor
        self.t_no = 0
...
#        self.epsilon -= self.epsilon_decay_rate 
        self.t_no = self.t_no + 1
        self.epsilon = math.e**(-0.01 * self.t_no)
        self.alpha = math.e**(-0.001 * (self.t_no))
    ...
    def get_maxQ(self, state):
        ...
        maxQ = max(self.Q[state].values())#, key=self.Q[state].get)
    ...
    def createQ(self, state):
        ...
        # Update the Driving Agent State forum  
        # https://discussions.udacity.com/t/smartcab-project-help-creating-tuples-to-update-driving-agent-state/203372/10
        ...
        if self.learning:
            if self.epsilon > random.random():
                ...
                maxQ_actions = [key for key in self.Q[state].keys() if self.Q[state][
                    key] == maxQ]  # key mean ESC   ## ? line 79 maxQ = None 
